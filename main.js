    ...
    spaceProbes: [
      {
        ...
        // Highly elliptical polar orbit parameters
        orbit: {
          semiMajorAxis: 9.5, // Increased to prevent passing through planet (with eccentricity 0.75, periapsis is at 2.375 planet radii)
          ...
          argumentOfPeriapsis: 0,
          meanAnomaly: 0,
          orbitalPeriod: 53.5 // Days (JUNO's actual orbital period - originally planned 14 days but kept at 53.5 due to engine issues)
        },
    ...
    spaceProbes: [
      {
        ...
        size: 0.104, // Increased by 30% (0.08 * 1.3 = 0.104)
        // Elliptical orbit parameters - highly elliptical orbit
        orbit: {
          semiMajorAxis: 7, // 2x JUNO's semiMajorAxis (3.5 * 2 = 7)
          eccentricity: 0.65, // Highly elliptical orbit (more elongated)
          inclination: 0.05, // Same as JUNO
          argumentOfPeriapsis: 0, // Argument of periapsis
          meanAnomaly: 0, // Starting position
          orbitalPeriod: 30 // Days (Cassini's orbital period varied from 18 to 50 days)
        },
        color: new THREE.Color(0.85, 0.88, 0.92),
